...
const Page = () => {
  ...
  return (
    <PageSkeleton>
      <PageHeader
        breadcrumbs={[{ title: t('sidebar.employee_announcements') }]}
      />
      ...
      <Card padding={12} gap={20} loaderSize={32}>
        <Link
          to={AppRoutes[AppRoutesEnum.ADMIN_EMPLOYEE_ANNOUNCEMENTS_CREATE]()}
        >
          <Button>
        ...
        <Button variant="light" onClick={toggleIsDeleted}>
